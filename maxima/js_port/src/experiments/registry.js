...
export const EXPERIMENTS = [
  {
    ...
    description:
      'Builds the Z_2 orientation-cover cluster in exact Z[zeta_n], then measures d_eff, d_w, d_spec, holonomy, CA dynamics, KPM spectra and the Erdos distance catalog.',
  ...
  },
  {
    ...
    description:
      'Verifies golden-ratio / cyclotomic / dihedral / Laplacian identities numerically and sweeps the n-gon structural table.',
  ...
  },
  {
    ...
    description:
      'Analytic pentagonal-lattice catalog: norm form, ring table, Fibonacci spacing, Galois pairing, D(n) = O(log n).',
  ...
  },
  {
    ...
    description:
      'Edge-restricted reconnection: observed orientation group, sheet transitions, d_eff and hierarchy level.',
  ...
  },
  {
    ...
    description:
      'Runs the lattice experiment across a list of n and emits a comparison table plus CSV.',
  ...
  },
  {
    ...
    description:
      'Cheap assertions across n in {3,4,5,6}: cluster size, d_eff range, vortex fraction, Z_2 holonomy parity.',
